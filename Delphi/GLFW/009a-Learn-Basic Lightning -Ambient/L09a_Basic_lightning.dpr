...
const
  VERTICES: array [0..107] of single = (
    -0.5, -0.5, -0.5,
     0.5, -0.5, -0.5,
     0.5,  0.5, -0.5,
     0.5,  0.5, -0.5,
...
//  glfwSetKeyCallback(Window, KeyCallback);
  ...
  lightingShader:= TShader.Create('vertex.vs', 'colors.fs');
  lightCubeShader:= TShader.Create('vertex.vs', 'light_cube.fs');
  ...
  begin
    ...
    model := model * TMatrix3D.CreateTranslation(TPoint3D.Create(1.2, 1.0, 2.0));
    lightingShader.SetUniformMatrix4fv('model', model);
