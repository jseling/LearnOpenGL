...
var
  ...
  begin
    ...
    begin
        mixValue := mixValue + 0.001; // change this value accordingly (might be too slow or too fast based on system hardware)
        if(mixValue >= 1.0) then
            mixValue := 1.0;
    end;
...
//texture 2
  ...
  begin
    ...
    AShader.SetUniform1f('mixValue', mixValue);
