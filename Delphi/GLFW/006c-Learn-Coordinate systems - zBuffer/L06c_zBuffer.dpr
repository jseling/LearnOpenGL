...
//texture 2
  ...
  view := view * TMatrix3D.CreateTranslation(TPoint3D.Create(0, 0, -3));
...
    model := TMatrix3D.CreateRotation(TPoint3d.Create(0.5, 1, 0),  DegToRad(50) * glfwGetTime());
