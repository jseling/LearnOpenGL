program L02z3_Two_triangles_vbo_vao_shaders;
...
const
  FRAGMENT_SHADER_2 =
    ...
    'void main()'#10+
    '{'#10+
    '  FragColor = vec4(1.0f, 1.0f, 0.0f, 1.0f);'#10+
    '}';
...
//  Assert(glGetError = GL_NO_ERROR);
  ...
  Source := FRAGMENT_SHADER_1;
  //carrega o código fonte
  glShaderSource(FragmentShaderOrange, 1, @Source, nil);
//  Assert(glGetError = GL_NO_ERROR);
  //compila
  ...
  Source := FRAGMENT_SHADER_2;
  //carrega o código fonte
  glShaderSource(FragmentShaderYellow, 1, @Source, nil);
//  Assert(glGetError = GL_NO_ERROR);
  //compila
