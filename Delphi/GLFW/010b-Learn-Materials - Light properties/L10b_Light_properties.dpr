...
//  glfwSetKeyCallback(Window, KeyCallback);
  ...
  //--------------------------------------
    ...
    lightingShader.SetUniform3f('light.ambient',  0.2, 0.2, 0.2);
    lightingShader.SetUniform3f('light.diffuse',  0.5, 0.5, 0.5); // darken diffuse light a bit
